...
## User Interface Halaman Register
...
![](/user/database-user.png)

Perlu adanya penambahan column untuk menentukan level user. Level user yang dibutuhkan pada aplikasi ini ada 3 level, diantaranya :
