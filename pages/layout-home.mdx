...
Header pada dashboard sudah dijelaskan pada [Dashboard Home](/dashboard-home#bagian-header)
...
Sidebar pada dashboard sudah dijelaskan pada [Dashboard Home](/dashboard-home#bagian-navigation)
...
![footer dashboard](/dashboard-home/footer.png)
